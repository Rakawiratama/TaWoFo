...
// Menangani aksi Edit dan Delete
if (isset($_GET['edit_id'])) {
    $editId = $_GET['edit_id'];
    // Mengambil data karyawan yang dipilih
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        // Query untuk update data payroll
        ...
        // Setelah update, redirect ke halaman laporan
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="action-buttons">
                            <a href="reports.php?edit_id=<?php echo $report['payroll_id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
                            <a href="reports.php?delete_id=<?php echo $report['payroll_id']; ?>" class="btn btn-danger"><i class="fas fa-trash"></i> Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
