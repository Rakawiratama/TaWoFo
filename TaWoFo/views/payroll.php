    ...
    <div class="d-flex">
        ...
        <div class="main-content">
            ...
            <form method="POST" class="mb-4">
                <input type="hidden" name="id" value="<?php echo isset($payroll['id']) ? htmlspecialchars($payroll['id']) : ''; ?>"> <!-- ID payroll (jika ada) -->
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="month" class="form-select" required>
                            ...
                            <option value="1" <?php echo isset($payroll['month']) && $payroll['month'] == 1 ? 'selected' : ''; ?>>Januari</option>
                            <option value="2" <?php echo isset($payroll['month']) && $payroll['month'] == 2 ? 'selected' : ''; ?>>Februari</option>
                            <option value="3" <?php echo isset($payroll['month']) && $payroll['month'] == 3 ? 'selected' : ''; ?>>Maret</option>
                            <option value="4" <?php echo isset($payroll['month']) && $payroll['month'] == 4 ? 'selected' : ''; ?>>April</option>
                            <option value="5" <?php echo isset($payroll['month']) && $payroll['month'] == 5 ? 'selected' : ''; ?>>Mei</option>
                            <option value="6" <?php echo isset($payroll['month']) && $payroll['month'] == 6 ? 'selected' : ''; ?>>Juni</option>
                            <option value="7" <?php echo isset($payroll['month']) && $payroll['month'] == 7 ? 'selected' : ''; ?>>Juli</option>
                            <option value="8" <?php echo isset($payroll['month']) && $payroll['month'] == 8 ? 'selected' : ''; ?>>Agustus</option>
                            <option value="9" <?php echo isset($payroll['month']) && $payroll['month'] == 9 ? 'selected' : ''; ?>>September</option>
                            <option value="10" <?php echo isset($payroll['month']) && $payroll['month'] == 10 ? 'selected' : ''; ?>>Oktober</option>
                            <option value="11" <?php echo isset($payroll['month']) && $payroll['month'] == 11 ? 'selected' : ''; ?>>November</option>
                            <option value="12" <?php echo isset($payroll['month']) && $payroll['month'] == 12 ? 'selected' : ''; ?>>Desember</option>
                        </select>
                    </div>
